...
<?php
	...
	echo $this->Croogo->adminAction(
	   ...
	   $status_val = isset($this->request->query['status'])?$this->request->query['status']:'any';
		echo $this->Form->input('name',array('label' => false,'placeholder'=>'Serach...','value'=>$search_val));
$options =array(
	'any'=>'All',
	 'active'=>'Acitve',
	'inactive'=>'In Active'	
	...
	echo $this->Form->input(__d('croogo', 'Search'), array('type' => 'submit', 'label' => false));
	echo $this->Form->end();
?>
</div>
